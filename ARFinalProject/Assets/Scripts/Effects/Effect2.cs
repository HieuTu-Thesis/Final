...
public class Effect2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (_initEffect == true && _startIdx != _endIdx)
        {
            ...
            {
                if (_gameObjects[i].transform.FindChild("Name") != null) _gameObjects[i].transform.FindChild("Name").GetComponent<MeshRenderer>().enabled = false;
                if (_gameObjects[i].transform.FindChild("Price") != null) _gameObjects[i].transform.FindChild("Price").GetComponent<MeshRenderer>().enabled = false;
                if (_gameObjects[i].transform.FindChild("Type") != null) _gameObjects[i].transform.FindChild("Type").GetComponent<MeshRenderer>().enabled = false;
